...
contract TestingAavePool {
    ...
    function supplyLiquidity(uint _amount, address _token) payable public {
    ...
    function getUser(address _user) external view returns (DataTypes.UserConfigurationMap memory) {
